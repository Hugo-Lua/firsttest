...
class DatabaseSeeder extends Seeder
{
    ...
    {   
        Games::create([
            ...
            'short-description' => 'A deceptively addictive poker-based roguelike where you build decks, stack multipliers, and chase impossible scores. Its not really about poker — its about breaking the rules in the most satisfying way possible.',
        ...
        Games::create([
            ...
            'short-description' => 'Supergiant returns with a follow-up that is bigger, deeper, and more beautiful than the original. Play as Melinoe, daughter of Hades, cutting through Greek mythology with brutal combat and a story that unfolds across every single run.',
        ...
        Games::create([
            ...
            'short-description' => 'A fast-paced cyberpunk tower defence where you place and synergise squares to repel a robot invasion. With strategic depth, boss fights, an endless mode, and a gloriously chaotic premise — this is cubic perfection at its finest.',
        ...
        Games::create([
            ...
            'short-description' => 'A puzzle roguelite set in a manor that rebuilds itself from scratch every single day. You choose which rooms materialise as you open doors — and your accumulated knowledge is the only thing that carries between runs.',
        ...
        Games::create([
            ...
            'short-description' => 'A wildly energetic platformer built entirely around speed, momentum, and chaos. Sprint, wall-jump, and combo your way through a tower of absurd levels as Peppino Spaghetti, the most anxious chef in gaming history.',
        ...
        Games::create([
            ...
            'short-description' => 'A breathtaking French indie RPG blending classic turn-based combat with real-time parry and dodge mechanics. Set in a hauntingly beautiful world inspired by Belle Epoque France, it rivals any big-budget release in scope and ambition.',
        ...
        Games::create([
            ...
            'short-description' => 'A dense, atmospheric Metroidvania set inside a strange underground world filled with glowing creatures and layered secrets. Some of those secrets were designed to take the entire global player community months to uncover together.',
        ...
        Games::create([
            ...
            'short-description' => 'A fully procedural detective game set in a noir retro-futurist city where every citizen has a life, a schedule, and a secret. Every murder is unique, every investigation is different, and every solution belongs entirely to you.',
        ...
        Games::create([
            ...
            'short-description' => 'A deeply moving narrative game about a Tamil immigrant family in Canada, told through the act of recovering lost recipes. Short, beautiful, and emotionally devastating in the best possible way',
        ...
        Games::create([
            ...
            'short-description' => 'A charming action-adventure where a storybook hero can leap off the page into the real 3D world. Inventive, joyful, and packed with creative puzzles that play with the boundary between story and reality.',
